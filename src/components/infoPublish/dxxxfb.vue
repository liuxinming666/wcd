                ...
                <div>
                    <div style="float: left">
                        <div style="margin-left: 15px;margin-top: 5px;">
                            ...
                            &nbsp;&nbsp;
                            <el-select class="sel" style="width: 150px;" v-model="curTown" placeholder="选择乡镇">
                                <el-option
                                        v-for="item in towns"
                                        :label="item"
                                        :value="item">
                            ...
                            数据类型选择:
                            <el-select class="sel" style="width: 150px;" v-model="curDataType" placeholder="选择数据类型">
                                <el-option
                    ...
                    <div style="margin-left: 15px;margin-top: 5px;float: right;">
                        <el-button icon="el-icon-print" type="primary">打印表格</el-button>
                    </div>
                </div>
            </LayoutPanel>
    ...
    export default {
        ...
        methods:{
            ...
            initTowns:function () {
                ...
                this.towns = [];
                for(let i = 0;i<length;i++){
                    this.towns.push(Mock.Random.cword( 2, 3) + Mock.Random.cword('乡镇'));
                }
                this.curTown = this.towns[0];
            },
            ...
            onBtnClick:function () {
                ...
                if(this.curDataType == '雨情'){
                    for(let i = 0;i < 100;i++){
                        this.tableData.push({
                            col0:Mock.Random.cword( 2, 3) + '站',
                            col1:Mock.Random.datetime('yyyy-MM-dd HH:mm'),
                            col2:Mock.Random.float(10, 50, 2, 2),
                            col3:Mock.Random.integer( 1, 10 ),
                            col4:Mock.Random.integer( 0, 24 ),
                            col5:Mock.Random.float(5, 20, 2, 2),
                            col6:Mock.Random.cword('雪雨阴晴'),
                        });
                    }
                }
